...
export function Layout() {
    ...
    return (
            ...
            <footer className="bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <h4 className="font-semibold mb-3">Fundacja Grzegorza Kubiaka - Rozwój i Pasja</h4>
        ...
        ${copied ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10 pointer-events-none"}`}
                                ...
                                <br/>
                                Tel: <a className="hover:underline" href="tel:+48601896168" >+48 601 896 168
                                    <button className="ml-1 inline-flex items-center cursor-pointer hover:text-gray-700 transition-colors">
                                        <BsFillTelephoneFill />
                                    </button>
                                </a> <br/>
                                NIP: 1231597671<br/>
                        ...
                        <div>
                            <h4 className="font-semibold mb-3">Adres Fundacji</h4>
                            <p className="text-sm text-gray-400">
                                ul. Kamienna 16
                                <br/>
                                05-510 Czarnów
                                <br/>
                                <a
                                    href={"https://maps.app.goo.gl/9jVadXjdotz4rDE46"}
                            ...
                            <h4 className="font-semibold mb-1 mt-1">Treningi</h4>
                            <p className="text-sm text-gray-400">
                                ul. Sielska 1
                                <br/>
                                05-500 Siedliska
                                <br/>
                                <a
                                    href={"https://maps.app.goo.gl/AGF3d7FoyEeJFKWf6"}
                                    className="text-blue-400 hover:underline"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                    ...
                    <div className="border-t border-gray-800 mt-8 pt-6 text-center text-sm text-gray-400">
                        © {new Date().getFullYear()} Fundacja Grzegorza Kubiaka - Rozwój i Pasja. Wszelkie prawa
                        zastrzeżone.
                    </div>
                </div>
            </footer>
